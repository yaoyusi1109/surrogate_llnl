...
dgp8 <- fit_two_layer(xtrain, ytrain, D = 8, nmcmc = 10000, true_g = 1e-6)
plot(dgp8$ll, type = "l")
dgp8 <- trim(dgp8, 5000, 5)
...
dgp4 <- fit_two_layer(xtrain, ytrain, D = 4, nmcmc = 10000, true_g = 1e-6)
plot(dgp4$ll, type = "l")
dgp4 <- trim(dgp4, 5000, 5)
...
dgp2 <- fit_two_layer(xtrain, ytrain, D = 2, nmcmc = 10000, true_g = 1e-6)
plot(dgp2$ll, type = "l")
dgp2 <- trim(dgp2, 5000, 5)
