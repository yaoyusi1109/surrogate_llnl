...
par(mfrow = c(1, 2))
boxplot(bk$RMSE, zhang$RMSE, dgp_all$RMSE, dgp_ideal$RMSE, monodgp$RMSE, log = "y",
        names = c("BK", "Zhang", "DGP All", "DGP Ideal", "monoDGP"), ylab = "RMSE (log scale)")
boxplot(bk$CRPS, zhang$CRPS, dgp_all$CRPS, dgp_ideal$CRPS, monodgp$CRPS, log = "y",
        names = c("BK", "Zhang", "DGP All", "DGP Ideal", "monoDGP"), ylab = "CRPS (log scale)")
